...
This prompt presupposes `tack.ddd.profile = on` in **`TACK.md`**. If the flag is off, **STOP** and tell the human to enable the profile in **`TACK.md`** (Phase 5 of `tack-bootstrap`) before re-running.
