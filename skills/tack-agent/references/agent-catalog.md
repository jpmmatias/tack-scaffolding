...
|-------|------|-------|--------------|----------------------------|
| Worktree coordinator | `worktree-coordinator.md` | `[Composer]` | `worktree_coordinator` | Isolated branch/worktree; needs slug, `tack.worktree.*` from **`TACK.md`** / **`.cursorrules`**; OUTPUTS: JSON only |
