# Example: `.cursorrules` (OrderFlow Checkout — fictitious)

Save the active rules as `.cursorrules` at the repository root. This example mirrors the template structure.
