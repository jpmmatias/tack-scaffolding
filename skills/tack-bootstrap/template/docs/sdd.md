...
2. **Spec** — [product-manager prompt](../prompts/product-manager.md) **grills the requester one question at a time (with recommended answers)** and produces `specs/S-XXX-<slug>.md` from [specs/_template.md](../specs/_template.md).
